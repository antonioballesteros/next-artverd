...
export function CartCheckoutPageClient() {
    ...
    return (
      <div className="mx-auto max-w-2xl px-4 py-16 text-center">
        ...
        <p className="mt-4 text-emerald-900/85">
          Afegeix productes a la cistella abans d&apos;enviar la sol·licitud.
        </p>
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 md:py-14">
      ...
      <p className="mt-3 max-w-2xl text-sm text-emerald-800/85">
        Revisa el total estimat i envia les teves dades de contacte. Et
        respondrem per confirmar la comanda i les opcions de pagament o
        recollida.
      </p>
      ...
      <div className="mt-8 rounded-xl border border-emerald-200/90 bg-emerald-50/50 px-4 py-4 sm:px-6">
        ...
        <p className="mt-2 text-xs text-emerald-800/75">
          {lines.length === 1
            ? "1 article a la cistella."
            : `${lines.length} articles a la cistella.`}
        </p>
      </div>
