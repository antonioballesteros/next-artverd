...
export function HomeIntro() {
  return (
    <section className="mx-auto max-w-6xl px-4 py-14 md:py-20" aria-labelledby="intro-heading">
      <div className="grid items-center gap-10 md:grid-cols-2 md:gap-14">
        <div>
          <h2 id="intro-heading" className="font-semibold text-2xl text-emerald-950 md:text-3xl">
            Floristeria ArtVerd
          </h2>
          <div className="mt-6 max-w-3xl space-y-4 text-base leading-relaxed text-emerald-900/90 md:text-lg">
            <p>
              A la floristeria ArtVerd trobaràs rams, plantes i objectes de decoració per fer un regal únic i
              personalitzat, per cada ocasió. Sigui un ram de flors per un ésser estimat, per celebrar un naixement o
              un aniversari, o per organitzar el teu casament. Regala flors per a qualsevol ocasió.
            </p>
            <p>
              La teva floristeria a Terrassa: estem al centre, molt a prop de Mútua de Terrassa. Fem lliuraments a
              domicili.
            </p>
          </div>
          <ul className="mt-8 max-w-2xl list-disc space-y-2 pl-5 text-emerald-900/90 md:text-lg">
            <li>Àmplia varietat de plantes per cada racó, així com l’assessorament per tenir-ne cura.</li>
            <li>Accessoris per decorar la teva llar amb estil i personalitat.</li>
        ...
        <div className="relative aspect-[4/3] w-full overflow-hidden rounded-2xl border border-emerald-900/10 shadow-lg">
          <Image
            src={artverdLegacyImages.introTenda}
...
const PRODUCT_CATEGORIES: ProductCategory[] = [
  {
    ...
    imageSrc: artverdLegacyImages.categoryRams,
  ...
  },
  {
    ...
    imageSrc: artverdLegacyImages.categoryPlantes,
  ...
  },
  {
    ...
    imageSrc: artverdLegacyImages.categoryAccesoris,
  ...
  },
  {
    ...
    imageSrc: artverdLegacyImages.categoryEvents,
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl">
        <h2 id="products-heading" className="font-semibold text-2xl text-emerald-950 md:text-3xl">
          Els nostres productes
        </h2>
        <p className="mt-2 max-w-2xl text-emerald-900/80">
          Explora les línies principals de la botiga. Els enllaços es completaran a mesura que migrem cada secció.
        </p>
            ...
            <li key={cat.href}>
              ...
              >
                ...
                <div className="flex flex-1 flex-col p-5">
                  ...
                  <span className="mt-2 text-sm text-emerald-900/75">{cat.description}</span>
                  <span className="mt-4 text-sm font-semibold text-emerald-800">Veure més →</span>
                </div>
              </Link>
            </li>
          ))}
...
export function HomeBestSeller() {
  return (
    <section className="mx-auto max-w-6xl px-4 py-14 md:py-20" aria-labelledby="bestseller-heading">
      <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
        <div className="relative aspect-[4/3] w-full overflow-hidden rounded-2xl border border-emerald-900/10 shadow-md lg:order-first">
          <Image
            src={artverdLegacyImages.bestSeller}
        ...
        <div className="lg:order-last">
          <h2 id="bestseller-heading" className="font-semibold text-2xl text-emerald-950 md:text-3xl">
            Novetats · Best seller
          </h2>
          <p className="mt-6 max-w-3xl text-base leading-relaxed text-emerald-900/90 md:text-lg">
            Els nostres productes best seller són els més venuts i apreciats pels nostres clients. Descobreix la nostra
            selecció de productes destacats i troba el que millor s’adapti a les teves necessitats. A ArtVerd, t’oferim
            la millor qualitat i varietat de flors i plantes perquè el teu espai es converteixi en un lloc únic i
            especial.
          </p>
          <p className="mt-8">
            <Link
...
export function HomeWorkshops() {
  return (
    <section className="border-t border-emerald-900/10 bg-white px-4 py-14 md:py-20" aria-labelledby="workshops-heading">
      <div className="mx-auto max-w-6xl">
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
          <div>
            <h2 id="workshops-heading" className="font-semibold text-2xl text-emerald-950 md:text-3xl">
              Tallers florals
            </h2>
            <p className="mt-6 max-w-3xl text-base leading-relaxed text-emerald-900/90 md:text-lg">
              Descobreix els nostres tallers florals a ArtVerd i aprèn a crear arranjaments espectaculars amb les millors
              flors i plantes. T’oferim tallers per a tots els nivells, des de principiants fins a experts, perquè puguis
              gaudir de l’art floral independentment de la teva experiència. Vine a viure una experiència única i creativa
          ...
          <div className="relative aspect-[4/3] w-full overflow-hidden rounded-2xl border border-emerald-900/10 shadow-md">
            <Image
              src={artverdLegacyImages.workshopsRams}
...
const TESTIMONIALS: Testimonial[] = [
  ...
  {
    quote: "Una noia amb molt traça i molt bon gust. No és pas una floristeria convencional!",
    author: "ramon grimalt",
  },
  {
    quote: "Flors i rams preciosos i a més mil detalls per inspirar-te! Hi tornaré segur!",
  ...
  {
    quote: "Una botiga molt variada i una dependenta amb molt bon gust. Un plaer.",
  ...
  return (
    ...
    >
      <div
        ...
        style={{ backgroundImage: `url(${artverdLegacyImages.flowerSectionBg})` }}
        aria-hidden
      />
      <div className="relative mx-auto max-w-6xl">
        <h2 id="reviews-heading" className="font-semibold text-2xl text-emerald-950 md:text-3xl">
          Els nostres clients opinen
        </h2>
        <p className="mt-2 text-sm text-emerald-800/80">
          Opinions recollides de ressenyes públiques sobre la botiga (contingut estàtic en aquesta fase).
        </p>
...
const SOCIAL_LINKS: SocialLink[] = [
  {
    ...
    label: "Instagram",
    iconSrc: artverdLegacyImages.socialInstagram,
  },
  {
    href: "https://www.facebook.com/artverdflors/?locale=es_ES",
    label: "Facebook",
    iconSrc: artverdLegacyImages.socialFacebook,
  },
...
export function HomeSocialAndContact() {
  return (
    <section className="mx-auto max-w-6xl px-4 py-14 md:py-20" aria-labelledby="social-heading">
      <div className="grid gap-12 md:grid-cols-2 md:gap-16">
        <div>
          <h2 id="social-heading" className="font-semibold text-2xl text-emerald-950 md:text-3xl">
        ...
        <div>
          ...
          <ul className="mt-6 space-y-3 text-emerald-900/90">
            <li>
              <a href="tel:+34682242445" className="font-semibold text-emerald-800 hover:underline">
                682 242 445
              </a>
            </li>
            ...
            <li>
              <a href="mailto:artverd@gmail.com" className="text-emerald-800 hover:underline">
                artverd@gmail.com
              </a>
            </li>
          </ul>
