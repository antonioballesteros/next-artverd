  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-5xl px-4 text-center">
        <h1
          id={id}
          className={`${elsie.className} text-4xl font-normal tracking-wide text-white animate-[blog-article-hero-in_0.75s_ease-out_both] opacity-0 md:text-6xl lg:text-7xl`}
          style={{ animationDelay: "60ms", animationFillMode: "forwards" }}
        >
          {title}
        </h1>
        <div
          className="mx-auto mt-6 h-px w-28 origin-center bg-emerald-300/90 animate-[blog-title-line_0.95s_ease-out_both] opacity-0 md:mt-8"
