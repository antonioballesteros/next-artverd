...
export async function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <li>
      <Card className="h-full gap-0 overflow-hidden rounded-2xl border border-emerald-200/80 bg-white py-0 shadow-sm transition hover:border-emerald-300 hover:shadow-md">
        <Link
          href={productHref}
        ...
        <CardContent className="flex flex-1 flex-col gap-2 p-4 md:p-5">
          <h3
